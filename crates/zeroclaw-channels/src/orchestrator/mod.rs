...
async fn process_channel_message(
    ...
    let mut system_prompt =
        crate::orchestrator::build_channel_system_prompt_helper::build_channel_system_prompt(
            &base_system_prompt,
            &ctx.prompt_config,
            &msg.channel,
            &msg.reply_target,
...
pub async fn start_channels(config: Config) -> Result<()> {
    ...
    let deferred_wire_out = zeroclaw_runtime::tools::deferred_wire::wire_deferred_tool_surfaces(
        &config,
        &mut built_tools,
