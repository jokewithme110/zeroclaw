...
cli-skills-bootstrap-templates-about = Initialiser les compétences modèles intégrées dans le répertoire local des compétences
...
cli-skills-bootstrap-created = {$count} fichiers de modèles initialisés sous {$dir}
cli-skills-bootstrap-existing = Les compétences modèles intégrées existent déjà sous {$dir}
