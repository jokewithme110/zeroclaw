...
use zeroclaw_api::attribution::{self, Attributable};
...
impl Attributable for SkillScanReportTool {
    fn role(&self) -> attribution::Role {
        attribution::Role::Tool(attribution::ToolKind::Shell)
    }
    ...
    async fn execute(&self, args: serde_json::Value) -> anyhow::Result<ToolResult> {
            ...
            .ok_or_else(|| {
                ::zeroclaw_log::record!(
                    ...
                    ::zeroclaw_log::Event::new(module_path!(), ::zeroclaw_log::Action::Fail)
                        ...
                        .with_attrs(::serde_json::json!({ "reason": "missing_skill_name" })),
                    "skill_scan_report missing 'skill_name' parameter"
                );
                ::anyhow::Error::msg("Missing 'skill_name' parameter")
            })?
            .to_string();
        ...
        .map_err(|err| {
            ::zeroclaw_log::record!(
                ...
                "skill_scan_report join error"
            );
            ::anyhow::Error::msg(format!("skill_scan_report join error: {err}"))
        })??;
